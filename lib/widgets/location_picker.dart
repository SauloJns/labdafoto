...
class _LocationPickerState extends State<LocationPicker> {
  ...
  Future<void> _getCurrentLocation() async {
    ...
    try {
      final Map<String, dynamic>? result = await LocationService.instance.getCurrentLocationWithAddress();
  ...
  Future<void> _searchAddress() async {
    ...
    try {
      final Location? location = await LocationService.instance.getLocationFromAddress(
